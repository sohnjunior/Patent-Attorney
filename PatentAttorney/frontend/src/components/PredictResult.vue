    ...
    <v-layout justify-center wrap>
      <v-flex xs12 md4>
        <v-card class="mx-auto" max-width="300px">
            <v-img class="indigo--text align-end" height="auto" width="200px"
                   :src="`data:image/jpeg;base64,${images[0]}`"></v-img>
             <hr/>
          <v-card-title>Request Image</v-card-title>
        </v-card>
      </v-flex>
      <v-flex xs12 md8 >
        <!-- <v-card>
          ...
          <v-data-table :headers="headers" :items="items" class="text-no-wrap">
            ...
            <template v-slot:item.temp="{ items }" >
              ...
              <td>
                 <img :src="`data:image/jpeg;base64,${images[1][0]}`" style="height:auto;width:200px">
              </td>
              <td></td>
              <td></td>
              <td></td>
